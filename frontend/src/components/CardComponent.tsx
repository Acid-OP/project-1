...
export function CardComponent() {
    return (
        <div className="h-[900px] w-[602px] bg-[#262522] rounded-lg m-4 relative overflow-hidden">
            <div
                className="w-full h-[200px] bg-[#21201d] top-0 left-0 text-white text-4xl font-black flex items-center justify-center relative"
            ...
            <CardComponentSocials
                    startIcon={<SocialIcon src={twitter} alt="Sample Icon" />}
                    onClick={() => console.log("Button clicked")}
                />
            <CardComponentSocials
                    startIcon={<SocialIcon src={instagram} alt="Sample Icon" />}
                    onClick={() => console.log("Button clicked")}
                />
            </div>
        </div>
